...
import controller.MenuExampleMouseController;
...
public class MenuExampleView extends JFrame {
	...
	public MenuExampleView() {
		...
		jPopupMenu.add(jButton_Copy);
		MenuExampleMouseController menuExampleMouseController =new MenuExampleMouseController(this);
		this.addMouseListener(menuExampleMouseController);
		this.add(jPopupMenu);
