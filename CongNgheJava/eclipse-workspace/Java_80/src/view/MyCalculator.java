...
public class MyCalculator extends JFrame {
	public MyCalculator() {
		...
		/*
		 * this.add(jTextField); this.add(jButton_0); this.add(jButton_1);
		 * this.add(jButton_2); this.add(jButton_3); this.add(jButton_4);
		 * this.add(jButton_5); this.add(jButton_6); this.add(jButton_7);
		 * this.add(jButton_8); this.add(jButton_9); this.add(jButton_cong);
		 * this.add(jButton_tru); this.add(jButton_nhan); this.add(jButton_chia);
